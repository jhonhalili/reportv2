...
const campusColors = {
  ...
  Meycauayan: "#FACC15",
  "San Fernando": "#4ADE80",
  "San Jose Del Monte": "#FB923C",
  "San Jose Nueva Ecija": "#F87171",
  "Sta. Maria": "#60A5FA",
  Tarlac: "#A78BFA",
  Bacoor: "#F87171",
  Balayan: "#34D399",
  ...
  Tanauan: "#FBBF24",
  Tanay: "#F472B6",
  "Puerto Princesa": "#38BDF8",
  Legazpi: "#C084FC",
  Naga: "#FACC15",
  "Bacolod - West Negros University": "#4ADE80",
  Kalibo: "#FB923C",
  Dumaguete: "#F87171",
  Calbayog: "#60A5FA",
  Maasin: "#A78BFA",
  Ormoc: "#F87171",
  "Cagayan de Oro": "#34D399",
  Iligan: "#FBBF24",
  Malaybalay: "#F472B6",
  Valencia: "#38BDF8",
  Davao: "#C084FC",
  Tagum: "#FACC15",
  "General Santos": "#4ADE80",
  Koronadal: "#FB923C",
  Tacurong: "#F87171",
  Surigao: "#60A5FA",
};
...
const dummyEnrollmentData = {
  "2024-2025": {
    ...
    Meycauayan: 105,
    "San Fernando": 144,
    "San Jose Del Monte": 190,
    "San Jose Nueva Ecija": 140,
    "Sta. Maria": 150,
    Tarlac: 80,
    //region IV-A
    Bacoor: 75,
    ...
    Naga: 75,
    //Region VI
    "Bacolod - West Negros University": 500,
    Kalibo: 390,
    //Region VII
    Dumaguete: 75,
    //Region VIII
  ...
  "2025-2026": {
    ...
    Meycauayan: 155,
    "San Fernando": 244,
    "San Jose Del Monte": 290,
    "San Jose Nueva Ecija": 240,
    "Sta. Maria": 250,
    Tarlac: 180,
    //region IV-A
    Bacoor: 175,
...
function renderRegionButtons(island) {
  ...
  regionsByIsland[island].forEach((region) => {
    ...
    btn.className =
      "text-sm px-4 py-2 bg-[#3B82F6] text-white rounded hover:bg-[#3a65aa]";
    btn.onclick = () => {
      activeRegion = region;
      updateCampusChart(region);
    };
    container.appendChild(btn);
  });
  // Reset chart if no active region
  if (!activeRegion || !regionsByIsland[island].includes(activeRegion)) {
    activeRegion = null;
...
function updateCampusChart(region) {
  const year = document.getElementById("campusYearFilter").value;
  const campuses = campusesByRegion[region] || [];
  ...
  campuses.forEach((campus) => {
    labels.push(campus);
    data.push(dummyEnrollmentData[year][campus] || 0);
    backgroundColors.push(campusColors[campus] || "#f9fafb"); // fallback color
  });
  ...
  if (campusChart) {
    ...
    const ctx = document
      .getElementById("campusEnrollmentChart")
      .getContext("2d");
...
document.getElementById("campusYearFilter").addEventListener("change", () => {
  if (activeRegion) updateCampusChart(activeRegion);
});
